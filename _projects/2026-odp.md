...
<div style="display: flex; justify-content: center; gap: 20px;">
  <img src="{{ site.baseurl }}/assets/images/shaft.jpg" width="250"style="margin-bottom: 30px;>
  <img src="{{ site.baseurl }}/assets/images/top_view.jpg" width="250"style="margin-bottom: 30px;>
</div>
